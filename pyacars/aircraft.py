...
class Aircraft():
    ...
    def height(self):
        return DataRef.get_f("sim/cockpit2/gauges/indicators/radio_altimeter_height_ft_pilot")

    def ias(self):
        return DataRef.get_f("sim/flightmodel/position/indicated_airspeed")

    def verticalspeed(self):
        return DataRef.get_f("sim/flightmodel/position/vh_ind_fpm")
